...
```bash
json-server db.txt -m ./node_modules/json-server-auth
...
```bash
json-server db.txt -m ./node_modules/json-server-auth -r routes.json
# with json-server installed globally and json-server-auth installed locally
```
...
```bash
json-server-auth db.txt -r routes.json
# with json-server-auth installed globally
```
